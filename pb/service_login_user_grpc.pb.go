...
func (c *loginClient) LoginUser(ctx context.Context, in *LoginUserResponse, opts ...grpc.CallOption) (*LoginUserResponse, error) {
	out := new(LoginUserResponse)
	err := c.cc.Invoke(ctx, "/processor_message.Login/LoginUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLoginServer) LoginUser(context.Context, *LoginUserResponse) (*LoginUserResponse, error) {
...
func _Login_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/processor_message.Login/LoginUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).LoginUser(ctx, req.(*LoginUserResponse))
	}
...
var Login_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "processor_message.Login",
	...
	Metadata: "service_login_user.proto",
}
